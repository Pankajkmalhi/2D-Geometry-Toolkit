...
def draw_convex_hull(lines, canvas):
    ...
    for i in range(len(lines) - 1):
        ...
        canvas.create_line(
            p1.x, p1.y, p2.x, p2.y, fill="red", width=2, tags="convex_hull"
        )

    # Connect first and last points with a line
    p1, p2 = lines[-1], lines[0]
    canvas.create_line(p1.x, p1.y, p2.x, p2.y, fill="red", width=2, tags="convex_hull")
